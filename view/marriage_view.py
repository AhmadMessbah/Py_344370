...
class MarriageView:
    ...
    def save_click(self):
        status, message = self.marriage_controller.save(self.name.get(), self.family.get(), self.age.get())
        if status:
    ...
    def edit_click(self):
        status, message = self.marriage_controller.edit(self.id.get(), self.name.get(), self.family.get(), self.age.get())
        if status:
    ...
    def __init__(self):
        self.marriage_controller = PersonController()
        self.win = Tk()
