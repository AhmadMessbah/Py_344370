...
def save(person_id, university, grade, average, start_date, end_date):
    transaction_manager('insert into educations (person_id ,university, grade, average, start_date, end_date) values (?,?,?,?,?,?)',
                        [person_id, university, grade, average, start_date, end_date],
                        commit=True)


def edit(id, person_id, university, grade, average, start_date, end_date):
    transaction_manager('update educations set person_id=?, university=?,'
...
def remove(id):
    transaction_manager('delete from educations where id =?',
                        [id],
                        commit=True)
